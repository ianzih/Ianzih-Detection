...
# 模型輸出儲存的檔案
WEIGHTS_FINAL = './logs/model-resnext101-final'+str(Learning_rate)+'.h5'

WEIGHTS = './logs/resnext101-071522.h5'
...
plt.savefig('./model_resnext101_loss'+str(Learning_rate)+'.jpg')